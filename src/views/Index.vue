    ...
    <div class="container-fluid">
      ...
      <div class="row no-gutters floor1 mb-5 fade-in">
        ...
        >
          ...
          <p><router-link to="/gcxian" class="font_16">查看</router-link></p>
        </div>
        <div
      ...
      <div class="row no-gutters floor2 fade-in">
        ...
        <div class="col-sm-6 col-lg-3 p-2 fade-in">
          <router-link to="/foods" class="d-block f2">
            <i class="mask"></i>
            <span class="words">
        ...
        <!-- hotel -->
        <div class="col-sm-6 col-lg-3 p-2 fade-in">
          <a href="/hotels" class="d-block f2">
            <i class="mask"></i>
            <span class="words">
        ...
        <!-- shopping -->
        <div class="col-sm-6 col-lg-3 p-2 fade-in">
          <router-link to="/shopping" class="d-block f2">
            <i class="mask"></i>
            <span class="words">
